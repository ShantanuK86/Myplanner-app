...
import TicTacToe from './widgets/MyCustomWidget';
function App() {
 const [widgets, setWidgets] = useState([
  ...
  { id: new Date().getTime() + 3, component: <TicTacToe />, area: 'rightmost-widget', name:"TicTacToe" },
 ])
  ...
  <>
   ...
   >
    <p
     ...
     style={{ background: "none", border: "none", color: "black", fontSize: "30px", cursor: "pointer", backgroundColor: "white", borderRadius: "50%", width: "50px", display: "flex", justifyContent: "center", alignItems: "center", height: "50px", position: "fixed", rightmost: "10px", right: "10px" }}
    >+</p>
   </div>
            ...
            <div style={{ padding: 10,}} className='widget-container' >
             <div style={{ marginRightmost: 10 }}>
              ...
              >
               ...
               <option value="rightmost-widget">Rightmost</option>
              </select>
              <button
               onClick={() => {
   ...
   <div className="App">
    <div className="container">
     ...
     <div className="rightmost-widget">
      {widgets.length > 0 && widgets.map((widget, index) => {
      if (widget.area === 'rightmost-widget') {
        return (
          <div style={{ padding: 10, textAlign: 'center' }} className="widget-container" key={widget.id}>
            <div style={{ marginRightmost: 10 }}>
              <select
                value={widget.area}
                onChange={(e) => {
      ...
      {widgets.filter(widget => widget.area === 'rightmost-widget').length < 2 &&
       <button
        className='add-widget-button'
        onClick={() => {
         setShowWidgetModal(true)
         setSelectedWidgetArea('rightmost-widget')
        }}>+ Add Widget</button>
      }
      </div>
